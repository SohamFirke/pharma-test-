...
async function sendMessage() {
    ...
    try {
        ...
        // Display bot response - handle both 'response' and 'message' fields
        const botMessage = data.response || data.message || 'No response received';
...
function toggleVoiceRecognition() {
    if (!recognition) {
        alert('❌ Voice recognition is not supported in your browser.\n\nPlease use Chrome or Microsoft Edge for voice input.');
        return;
    }
